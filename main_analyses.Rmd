...
gpt35 <- read.csv('data/manuscript/10_runs/gpt35-expt1.csv')
gpt4 <- read.csv('data/manuscript/10_runs/gpt4-expt1.csv')
gpt4o <- read.csv('data/manuscript/10_runs/gpt4o-expt1.csv')
gpt45 <- read.csv('data/manuscript/10_runs/gpt45-expt1.csv')
gem15 <- read.csv('data/manuscript/10_runs/gem15-expt1.csv')
gem20 <- read.csv('data/manuscript/10_runs/gem20-expt1.csv')

data <- rbind(scope, gpt35, gpt4, gpt4o, gpt45, gem15, gem20)
```
...
ggplot(exp1_m_df, aes(x=value, y=scope, color=model, fill=model)) +
  ...
  scale_color_discrete(labels = c("gpt35" = "GPT-3.5", "gpt4" = "GPT-4", "gpt4o" = "GPT-4o", "gem15" = "Gemini-15", "gpt45" = "GPT-4.5", "gem20" = "Gemini-20")) +
  scale_fill_discrete(labels = c("gpt35" = "GPT-3.5", "gpt4" = "GPT-4", "gpt4o" = "GPT-4o", "gem15" = "Gemini-15", "gpt45" = "GPT-4.5", "gem20" = "Gemini-20")) +
  theme_bw() + 
...
# ggsave("figures/exp1_means_10runs.png", width = 7.29, height = 4.5)
```
...
ggplot(exp1_sd_df, aes(x=value, y=scope, color=model, fill=model)) +
  ...
  geom_point(alpha=0.15, size=1, shape=1) +
  geom_smooth(method="lm", size=0.5) +
  stat_cor(aes(label = ..r.label..), method = "pearson", digits = 3, show.legend = F, size = 2, label.x.npc = 0.7, label.y.npc = 0.5) +
  labs(x = "Model", y = "Human", color ="Model", fill = "Model") +
  scale_color_discrete(labels = c("gpt35" = "GPT-3.5", "gpt4" = "GPT-4", "gpt4o" = "GPT-4o", "gem15" = "Gemini-15", "gpt45" = "GPT-4.5", "gem20" = "Gemini-20")) +
  scale_fill_discrete(labels = c("gpt35" = "GPT-3.5", "gpt4" = "GPT-4", "gpt4o" = "GPT-4o", "gem15" = "Gemini-15", "gpt45" = "GPT-4.5", "gem20" = "Gemini-20")) +
  theme_bw() + 
...
# ggsave("figures/exp1_sds_10runs.png", width = 7.29, height = 4.5)
```
